...
if (len(sys.argv) > 1):
    ...
    print("type a numbre between 1 and 4, for random polygone type 0")
    sys.exit("type a number between 1 and 4, for random polygone type 0")
...
print("Size of the area",areasize(polygone))
print("Value of the area that we found",aire(poly2list(pos2rect(best_route))))
print("difference between the size of the surface and the area that we found",lostarea(polygone,poly2list(pos2rect(best_route))))"""
# FIN : affichages
dessine(polygonefig, poly2list(pos2rect(best_route)))
plt.show()
